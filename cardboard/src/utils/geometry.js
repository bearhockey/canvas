var GEO = (function () {
  ...
  geo.DrawRoundedRect = function(ctx, xPos, yPos, iWidth, iHeight, iRadius, color, outlineColor=null)
  {
    ctx.fillStyle = color;
    ctx.beginPath();
  ...
  geo.DrawCross = function(ctx, x, y, iRadius, color)
  {
    ctx.fillStyle = color;
    ctx.beginPath();
    ctx.fillRect(x - iRadius, y - (iRadius/2), iRadius*2, iRadius);
    ctx.fillRect(x - (iRadius/2), y - iRadius, iRadius, iRadius*2);
    ctx.closePath();
  };
