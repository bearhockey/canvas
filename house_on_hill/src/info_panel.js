var INFO_PANEL = (function () {
  ...
  info.Update = function(idx, iFloor=-1)
  {
    var objCurrentTile = LEVEL.GetTileByIndex(idx); // TODO: floor
    strRoomName = info.txtLocation.innerHTML = objCurrentTile.strLabel;
    strRoomDesc = (objCurrentTile.strDescription) ? objCurrentTile.strDescription : DEFAULT_DESC;
    info.imgRoomPreview.src = ROOM_SRC + ((objCurrentTile.strImage) ? objCurrentTile.strImage : DEFAULT_THUMB);
    info.UpdateInfoBody();
  };
